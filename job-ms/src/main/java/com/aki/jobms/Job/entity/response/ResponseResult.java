package com.aki.jobms.Job.entity.response;
...
public class ResponseResult<T> {
    ...
    public ResponseResult<T> error(int code, String message, T data) {
        this.code = code ;
        this.message = message ;
        this.data = data ;
    ...
    public static <T> ResponseResult<T> errorWithCodeAndMsg(HttpCodeEnum httpCodeEnum, T data) {
        ResponseResult<T> responseResult = new ResponseResult<>() ;

        return responseResult.error(httpCodeEnum.getCode(), httpCodeEnum.getMessage(), data) ;
    }
}
